...
class Checkpoint():
    ...
    def load(self, load_path):
        ...
        # TBD: This should be in self.model.trainer.load or self.model.trainer.policy_optimizer.load after refactoring
        # PolicyOptimizers to handle their own bookkeeping
        if self.model.trainer.priority_queue is not None:
